...
for {set i 1} {$i <= $numIterations} {incr i 1} {
  puts -nonewline "Iteration $i "
  set val [dbtestnumber 2 0]
  set topval [dbtestnumber 60 0]
  append val ".00"
  append topval ".00"
  set counter 0
  while { $val < $topval } {
