...
if [ catch { load ../../lib/libcdbtcl$SLE } result ] {
  puts stderr "flogreindex1.tcl: could not load ../../lib/libcdbtcl$SLE: $result"
  exit 1
}
...
puts $fadd1 {  midx "fr1_lfnidx" 512:case "LName", "FName";}
puts $fadd1 "\};"
puts $fadd1 ""
close $fadd1
...
if { $status } {
  ...
  file delete -force fr1_lfnidx.inx
  file delete -force fr1_lfnidx.idx
}
